...
import com.mfu.config.oauth2.OAuth2AuthenticationReadConverter;
...
@Configuration
@EnableMongoRepositories("com.mfu.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.mfu.config.dbmigrations");
