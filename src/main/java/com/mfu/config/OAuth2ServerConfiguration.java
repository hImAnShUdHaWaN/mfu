...
import com.mfu.config.oauth2.MongoDBApprovalStore;
import com.mfu.config.oauth2.MongoDBAuthorizationCodeServices;
import com.mfu.config.oauth2.MongoDBClientDetailsService;
import com.mfu.config.oauth2.MongoDBTokenStore;
import com.mfu.repository.*;
...
public class OAuth2ServerConfiguration {
    ...
    protected static class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
        ...
        public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
            resources.resourceId("res_mfu").tokenStore(tokenStore);
        }
    }
